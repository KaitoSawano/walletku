...
android {
    namespace = "fr.acinq.feesafe.android"
    compileSdk = 36
    defaultConfig {
        applicationId = "fr.acinq.feesafe.mainnet"
        minSdk = 26
        targetSdk = 36
        versionCode = 118
        versionName = "2.8.2"
    ...
    buildTypes {
        ...
        applicationVariants.all {
            outputs.forEach {
                val apkName = "feesafe-${defaultConfig.versionCode}-${defaultConfig.versionName}-${chain.drop(1).dropLast(1)}-${buildType.name}.apk"
...
dependencies {
    implementation(project(":feesafe-shared"))
