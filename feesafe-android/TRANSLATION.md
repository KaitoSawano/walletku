...
- [`important_strings.xml`](https://github.com/ACINQ/feesafe/blob/master/feesafe-android/src/main/res/values/important_strings.xml): a "short" file that contains the most important resources, like instructions, guidelines, or error messages.
- [`strings.xml`](https://github.com/ACINQ/feesafe/blob/master/feesafe-android/src/main/res/values/strings.xml): contains all the less important resources.
...
3. Create a new folder for this language, named `values-mylanguagecode`, in `feesafe-android/src/main/res`. For example, for french you would create a `values-fr` folder.
4. Copy the `feesafe-android/src/main/res/values/important_strings.xml` and `feesafe-android/src/main/res/values/strings.xml` files into this new folder.
