...
import fr.acinq.feesafe.android.components.settings.SettingButton
    ...
    DefaultScreenLayout {
        ...
        Card {
            ...
            SettingButton(
                ...
                onClick = { openLink(context, "https://feesafe.acinq.co/support") }
            )
        }
        Card {
            SettingButton(
                ...
                onClick = { openLink(context, "https://feesafe.acinq.co/privacy") }
            )
            SettingButton(
                text = stringResource(R.string.about_terms_link),
                icon = R.drawable.ic_text,
                onClick = { openLink(context, "https://feesafe.acinq.co/terms") }
            )
        }
    }
}
