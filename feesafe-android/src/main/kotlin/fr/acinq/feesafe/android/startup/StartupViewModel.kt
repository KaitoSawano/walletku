...
import fr.acinq.feesafe.android.services.ContactsPhotoCleaner
...
class StartupViewModel(
    ...
    fun startupNode(walletId: WalletId, words: List<String>, onStartupSuccess: (FeeSafeBusiness) -> Unit) {
