...
import fr.acinq.feesafe.android.BaseWalletId
import fr.acinq.feesafe.android.EmptyWalletId
...
class GlobalPrefs(private val data: DataStore<Preferences>) {
     ...
     *
     * Specifically, the FeeSafe SeedManager may be managing more or less seeds than this list contain ; if so the SeedManager is
    ...
    /** Returns the build code of the last FeeSafe instance that has been run on the device. Used for migration purposes. */
