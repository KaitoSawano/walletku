...
import fr.acinq.feesafe.android.security.EncryptedSeed
...
class ResetWalletViewModel(val application: FeeSafeApplication, val walletId: WalletId) : ViewModel() {
    ...
    fun deleteWalletData(
        ...
        viewModelScope.launch(Dispatchers.IO + CoroutineExceptionHandler { _, e ->
            ...
            context.deleteDatabase("payments-${chain.feesafeName}-${walletId.nodeIdHash}.sqlite")
            context.deleteDatabase("channels-${chain.feesafeName}-${walletId.nodeIdHash}.sqlite")
            delay(500)
