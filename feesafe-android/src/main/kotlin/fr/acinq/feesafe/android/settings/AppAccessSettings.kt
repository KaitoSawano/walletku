...
import fr.acinq.feesafe.android.components.auth.pincode.PinDialogTitle
import fr.acinq.feesafe.android.components.auth.screenlock.CheckScreenLockPinFlow
import fr.acinq.feesafe.android.components.auth.screenlock.NewScreenLockPinFlow
import fr.acinq.feesafe.android.components.auth.spendinglock.CheckSpendingPinFlow
import fr.acinq.feesafe.android.components.auth.spendinglock.NewSpendingPinFlow
...
import fr.acinq.feesafe.android.components.prefs.ListPreferenceButton
import fr.acinq.feesafe.android.components.prefs.PreferenceItem
...
import fr.acinq.feesafe.android.utils.*
...
private fun CannotUseBiometrics(
    ...
    Setting(
        ...
        leadingIcon = { FeeSafeIcon(resourceId = R.drawable.ic_fingerprint, tint = MaterialTheme.colors.onSurface) },
...
private fun AutoScreenLockDelayPicker(
    ...
    ListPreferenceButton(
        ...
        leadingIcon = { FeeSafeIcon(resourceId = R.drawable.ic_lock) },
