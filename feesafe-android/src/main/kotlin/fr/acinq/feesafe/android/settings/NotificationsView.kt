...
import fr.acinq.feesafe.android.*
...
import fr.acinq.feesafe.android.home.TorDisconnectedDialog
import fr.acinq.feesafe.android.navigation.Screen
import fr.acinq.feesafe.android.services.ChannelsWatcher
...
import fr.acinq.feesafe.android.utils.converters.DateFormatter.toRelativeDateString
import fr.acinq.feesafe.android.utils.extensions.safeLet
import fr.acinq.feesafe.data.Notification
import fr.acinq.feesafe.data.WatchTowerOutcome
    ...
    when (notice) {
        ...
        Notice.CriticalUpdateAvailable -> {
            ImportantNotification(
                ...
                onActionClick = { openLink(context, "https://play.google.com/store/apps/details?id=fr.acinq.feesafe.mainnet") }
            )
        }
        ...
        Notice.MempoolFull -> {
            ImportantNotification(
                ...
                onActionClick = { openLink(context, "https://feesafe.acinq.co/faq#is-feesafe-affected-by-high-on-chain-fees") },
            )
        }
...
private fun ImportantNotification(
    ...
    Card(
        ...
        Row(modifier = Modifier.padding(top = 12.dp, start = 16.dp, end = 16.dp)) {
            FeeSafeIcon(resourceId = icon, tint = MaterialTheme.colors.primary, modifier = Modifier.size(18.dp))
            ...
            Column(modifier = Modifier.alignByBaseline()) {
                ...
                safeLet(actionText, onActionClick) { text, onClick ->
                    fr.acinq.feesafe.android.components.buttons.Button(
