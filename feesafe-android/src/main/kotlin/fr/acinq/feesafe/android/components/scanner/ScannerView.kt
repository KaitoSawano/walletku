...
package fr.acinq.feesafe.android.components.scanner
...
import fr.acinq.feesafe.android.utils.images.ZxingQrCodeAnalyzer
...
private fun BoxScope.CameraPermissionsView() {
    ...
    if (!cameraPermissionState.status.isGranted) {
        Card(
            ...
            // if user has denied permission, open the system settings for FeeSafe
