...
package fr.acinq.feesafe.android.settings.fees
...
import fr.acinq.feesafe.android.components.*
...
import fr.acinq.feesafe.android.components.inputs.InlineSatoshiInput
...
import fr.acinq.feesafe.android.components.settings.SettingSwitch
...
import fr.acinq.feesafe.data.MempoolFeerate
    ...
    Column(modifier = Modifier.padding(horizontal = 16.dp, vertical = 12.dp)) {
        ...
        when (mempoolFeerate) {
            null -> ProgressView(text = stringResource(id = R.string.liquiditypolicy_fees_estimation_loading), progressCircleSize = 16.dp, padding = PaddingValues(0.dp))
                ...
                Row {
                    FeeSafeIcon(resourceId = R.drawable.ic_info, modifier = Modifier.offset(y = 2.dp))
