...
package fr.acinq.feesafe.android.payments.details
...
import fr.acinq.feesafe.android.LocalBitcoinUnits
import fr.acinq.feesafe.android.LocalBusiness
import fr.acinq.feesafe.android.LocalFiatCurrencies
import fr.acinq.feesafe.android.R
import fr.acinq.feesafe.android.navigation.Screen
import fr.acinq.feesafe.android.components.AmountView
import fr.acinq.feesafe.android.components.buttons.Clickable
import fr.acinq.feesafe.android.components.dialogs.IconPopup
import fr.acinq.feesafe.android.components.TextWithIcon
import fr.acinq.feesafe.android.components.buttons.openLink
import fr.acinq.feesafe.android.components.buttons.txUrl
import fr.acinq.feesafe.android.primaryFiatRate
import fr.acinq.feesafe.android.navController
import fr.acinq.feesafe.android.payments.details.technical.TechnicalIncomingBolt11
import fr.acinq.feesafe.android.payments.details.technical.TechnicalIncomingBolt12
import fr.acinq.feesafe.android.payments.details.technical.TechnicalIncomingLegacyPayToOpen
import fr.acinq.feesafe.android.payments.details.technical.TechnicalIncomingLegacySwapIn
import fr.acinq.feesafe.android.payments.details.technical.TechnicalIncomingNewChannel
import fr.acinq.feesafe.android.payments.details.technical.TechnicalIncomingSpliceIn
import fr.acinq.feesafe.android.payments.details.technical.TechnicalOutgoingAutoLiquidity
import fr.acinq.feesafe.android.payments.details.technical.TechnicalOutgoingChannelClose
import fr.acinq.feesafe.android.payments.details.technical.TechnicalOutgoingLightning
import fr.acinq.feesafe.android.payments.details.technical.TechnicalOutgoingManualLiquidity
import fr.acinq.feesafe.android.payments.details.technical.TechnicalOutgoingSplice
import fr.acinq.feesafe.android.payments.details.technical.TechnicalOutgoingSpliceCpfp
import fr.acinq.feesafe.android.utils.converters.AmountConverter.toFiat
import fr.acinq.feesafe.android.utils.converters.AmountFormatter.toPrettyString
import fr.acinq.feesafe.android.utils.converters.DateFormatter.toAbsoluteDateTimeString
import fr.acinq.feesafe.android.utils.converters.MSatDisplayPolicy
import fr.acinq.feesafe.android.utils.copyToClipboard
import fr.acinq.feesafe.android.utils.mutedBgColor
import fr.acinq.feesafe.data.ExchangeRate
import fr.acinq.feesafe.data.WalletPaymentInfo
