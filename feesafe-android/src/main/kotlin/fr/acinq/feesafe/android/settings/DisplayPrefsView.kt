...
import fr.acinq.feesafe.android.utils.extensions.label
...
@Composable
private fun FiatCurrencyPreference(business: FeeSafeBusiness, walletId: WalletId, userPrefs: UserPrefs, scope: CoroutineScope) {
    ...
    val currencyManager = business.feesafeGlobal.currencyManager
