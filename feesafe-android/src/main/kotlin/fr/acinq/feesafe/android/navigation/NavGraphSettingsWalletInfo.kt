...
import fr.acinq.feesafe.android.settings.walletinfo.FinalWalletInfo
import fr.acinq.feesafe.android.settings.walletinfo.FinalWalletRefundView
import fr.acinq.feesafe.android.settings.walletinfo.SendSwapInRefundView
import fr.acinq.feesafe.android.settings.walletinfo.SwapInAddresses
import fr.acinq.feesafe.android.settings.walletinfo.SwapInSignerView
import fr.acinq.feesafe.android.settings.walletinfo.SwapInWallet
import fr.acinq.feesafe.android.settings.walletinfo.WalletInfoView
...
fun NavGraphBuilder.walletInfoNavGraph(navController: NavController, appViewModel: AppViewModel) {
    ...
    businessComposable(
        ...
        deepLinks = listOf(
            navDeepLink { uriPattern = "feesafe:swapinwallet/{walletId}" }
        )
