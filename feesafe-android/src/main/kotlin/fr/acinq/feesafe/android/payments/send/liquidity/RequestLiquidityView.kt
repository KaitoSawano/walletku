...
package fr.acinq.feesafe.android.payments.send.liquidity
...
import fr.acinq.feesafe.android.components.AmountWithFiatBelow
import fr.acinq.feesafe.android.components.buttons.BackButtonWithActiveWallet
import fr.acinq.feesafe.android.components.buttons.BorderButton
import fr.acinq.feesafe.android.components.buttons.Checkbox
import fr.acinq.feesafe.android.components.HSeparator
import fr.acinq.feesafe.android.components.dialogs.IconPopup
import fr.acinq.feesafe.android.components.ProgressView
import fr.acinq.feesafe.android.components.inputs.SatoshiDiscretePicker
import fr.acinq.feesafe.android.components.layouts.SplashLabelRow
...
import fr.acinq.feesafe.android.components.buttons.SmartSpendButton
...
import fr.acinq.feesafe.android.components.feedback.ErrorMessage
import fr.acinq.feesafe.android.components.feedback.InfoMessage
import fr.acinq.feesafe.android.components.feedback.SuccessMessage
import fr.acinq.feesafe.android.payments.send.spliceout.spliceFailureDetails
import fr.acinq.feesafe.android.utils.converters.AmountFormatter.toPrettyString
import fr.acinq.feesafe.android.utils.annotatedStringResource
import fr.acinq.feesafe.android.utils.mutedBgColor
import fr.acinq.feesafe.android.utils.orange
    ...
    Column(
        ...
        Row {
            ...
            IconPopup(
                ...
                popupLink = stringResource(id = R.string.liquidityads_faq_link) to "https://feesafe.acinq.co/faq#what-is-inbound-liquidity",
...
private fun LeaseEstimationView(
    ...
    SplashLabelRow(
        ...
        helpLink = stringResource(id = R.string.liquidityads_faq_link) to "https://feesafe.acinq.co/faq#what-happens-after-a-year-of-reserving-liquidity",
    ) {
        Column {
            Text(
