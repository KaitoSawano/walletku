...
package fr.acinq.feesafe.android.components.auth.screenlock
...
import fr.acinq.feesafe.android.components.auth.pincode.NewPinViewModel
import fr.acinq.feesafe.android.security.PinManager

class NewScreenLockPinViewModel(override val application: FeeSafeApplication, override val walletId: WalletId): NewPinViewModel() {
