...
package fr.acinq.feesafe.android.payments.history
...
import fr.acinq.feesafe.android.utils.converters.DateFormatter.toBasicAbsoluteDateString
import fr.acinq.feesafe.android.utils.converters.DateFormatter.toBasicAbsoluteDateTimeString
        ...
        when (val state = vm.databaseExportState) {
            is DatabaseExportState.Init, is DatabaseExportState.Failed -> {
                ...
                FilledButton(
                    ...
                    onClick = { saveDatabaseLauncher.launch("feesafe-payments-${walletId.nodeIdHash.take(8)}-${currentTimestampMillis().toBasicAbsoluteDateTimeString()}.sqlite") },
                    modifier = Modifier.fillMaxWidth(),
                    padding = PaddingValues(12.dp),
