...
package fr.acinq.feesafe.android.components.dialogs
        ...
        Row(modifier = Modifier.padding(4.dp), verticalAlignment = Alignment.CenterVertically) {
            Surface(
                ...
                Box(modifier = Modifier.padding(iconPadding)) {
                    FeeSafeIcon(icon, modifier = Modifier.size(iconSize), tint = if (showPopup) MaterialTheme.colors.onPrimary else iconTint)
                }
            }
