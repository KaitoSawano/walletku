...
import fr.acinq.feesafe.android.payments.details.PaymentDetailsView
import fr.acinq.feesafe.android.payments.receive.ReceiveView
import fr.acinq.feesafe.android.payments.send.SendView
...
fun NavGraphBuilder.paymentsNavGraph(navController: NavController, appViewModel: AppViewModel) {
    ...
    businessComposable(
        ...
        deepLinks = listOf(navDeepLink { uriPattern = "feesafe:payments/{walletid}/{id}" })
    ...
    businessComposable(
        ...
        deepLinks = listOf(
            ...
            navDeepLink { uriPattern = "feesafe:lightning:{data}" },
            navDeepLink { uriPattern = "feesafe:bitcoin:{data}" },
