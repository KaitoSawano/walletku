...
import fr.acinq.feesafe.android.navigation.baseNavGraph
import fr.acinq.feesafe.android.navigation.channelsNavGraph
import fr.acinq.feesafe.android.navigation.homeNavGraph
import fr.acinq.feesafe.android.navigation.navigateToPaymentDetails
import fr.acinq.feesafe.android.navigation.paymentsNavGraph
import fr.acinq.feesafe.android.navigation.settingsNavGraph
import fr.acinq.feesafe.android.navigation.walletInfoNavGraph
import fr.acinq.feesafe.android.utils.FeeSafeAndroidTheme
import fr.acinq.feesafe.android.utils.appBackground
import fr.acinq.feesafe.android.utils.datastore.getBitcoinUnits
import fr.acinq.feesafe.android.utils.datastore.getFiatCurrencies
import fr.acinq.feesafe.android.utils.datastore.getIsAmountInFiat
import fr.acinq.feesafe.android.utils.logger
...
private fun UpgradeRequiredBlockingDialog() {
    ...
    Dialog(
        ...
        Button(
            ...
            onClick = { openLink(context = context, link = "https://play.google.com/store/apps/details?id=fr.acinq.feesafe.mainnet") },
