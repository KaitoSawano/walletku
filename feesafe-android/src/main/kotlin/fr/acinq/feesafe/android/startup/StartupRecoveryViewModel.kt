...
class StartupRecoveryViewModel(
    ...
    fun recoverSeed(words: List<String>, onRecoveryDone: (WalletId) -> Unit) {
        ...
        viewModelScope.launch(Dispatchers.IO + CoroutineExceptionHandler { _, e ->
            ...
            val channelsDbFile = application.applicationContext.getDatabasePath("channels-${NodeParamsManager.chain.feesafeName}-$nodeIdHash.sqlite")
    ...
    class Factory(val application: FeeSafeApplication) : ViewModelProvider.Factory {
