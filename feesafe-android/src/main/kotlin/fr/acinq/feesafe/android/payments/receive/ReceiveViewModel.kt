    ...
    private fun monitorCurrentSwapAddress() {
        viewModelScope.launch {
            ...
            if (swapAddressFormat == SwapAddressFormat.LEGACY) {
                val legacySwapInAddress = peerManager.getPeer().feesafeSwapInWallet.legacySwapInAddress
                ...
                peerManager.getPeer().feesafeSwapInWallet.swapInAddressFlow.filterNotNull().collect { (newAddress, newIndex) ->
