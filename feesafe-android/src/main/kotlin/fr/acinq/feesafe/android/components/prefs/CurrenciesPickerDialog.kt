...
package fr.acinq.feesafe.android.components.prefs
...
import fr.acinq.feesafe.android.utils.extensions.getLabel
import fr.acinq.feesafe.android.utils.mutedTextFieldColors
...
fun CurrenciesPickerDialog(
    ...
    ModalBottomSheet(
        ...
        TextInput(
            ...
            staticLabel = null,
            leadingIcon = { FeeSafeIcon(resourceId = R.drawable.ic_inspect, tint = MaterialTheme.typography.caption.color) },
