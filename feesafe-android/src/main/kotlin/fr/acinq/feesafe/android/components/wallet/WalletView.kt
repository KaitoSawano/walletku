...
package fr.acinq.feesafe.android.components.wallet
...
import fr.acinq.feesafe.android.components.dialogs.PopupBasicDialog
    ...
    if (business != null) {
        PopupBasicDialog(
            ...
            if (showBalance) {
                ...
                Row {
                    FeeSafeIcon(resourceId = R.drawable.ic_send)
            ...
            if (showInbound) {
                ...
                Spacer(Modifier.height(4.dp))
                Row {
                    FeeSafeIcon(resourceId = R.drawable.ic_bucket)
                    Spacer(Modifier.width(4.dp))
