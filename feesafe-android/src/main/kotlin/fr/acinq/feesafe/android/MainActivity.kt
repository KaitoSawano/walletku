...
import fr.acinq.feesafe.android.services.HceService
import fr.acinq.feesafe.android.services.PaymentsForegroundService
import fr.acinq.feesafe.android.utils.nfc.NfcReaderCallback
...
class MainActivity : AppCompatActivity() {
     ...
     *
     * For example, instead of `feesafe:<invoice>`, use `lightning:<invoice>`.
     *
    ...
    private fun Intent.fixUri() {
        ...
        if (scheme == "feesafe" && ssp != null && (ssp.startsWith("lnbc") || ssp.startsWith("lntb") || ssp.startsWith("lnurl") || ssp.startsWith("lno"))) {
