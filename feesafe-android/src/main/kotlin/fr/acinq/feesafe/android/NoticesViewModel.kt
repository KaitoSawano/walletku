...
import fr.acinq.feesafe.managers.ConnectionsManager
...
class NoticesViewModel(
    ...
    private suspend fun monitorWalletContext() {
        application.feesafeGlobal.walletContextManager.walletContext.collect {
    ...
    private suspend fun monitorWalletNotice() {
        combine(application.feesafeGlobal.walletContextManager.walletNotice, internalPrefs.getLastReadWalletNoticeIndex) { notice, lastReadIndex ->
