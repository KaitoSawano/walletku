package fr.acinq.feesafe.data.lnurl

import fr.acinq.lightning.utils.msat
import fr.acinq.feesafe.utils.testLoggerFactory
...
class LnurlPayTest {
    ...
    fun lud17() {
        ...
        assertIs<Lnurl.Request>(Lnurl.extractLnurl("feesafe:lnurlp://$validClearLud17", logger))
    ...
    fun invoice_successaction_aes() {
        // same data as feesafe-android LnurlPayTest AES-decryption test, base64-encoded:
