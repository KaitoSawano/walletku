...
class ParserTest {
    ...
    fun test_prefixes() {
        ...
        listOf(
            address to "feesafe:bitcoin:$address",
            address to "feesafe:bitcoin://$address             ",
            address to "bitcoin://$address     ",
            address to "   bitcoin:$address",

            invoice to "feesafe:lightning:$invoice",
            invoice to " feesafe:lightning://$invoice",
            invoice to "    lightning:$invoice",
            invoice to "lightning://$invoice",

            lnurlw to " feesafe:lnurl:$lnurlw   ",
            lnurlw to "feesafe:lnurl://$lnurlw　",
    ...
    fun parse_email_like() {
        ...
        assertIs<EmailLikeAddress>(Parser.parseEmailLikeAddress("feesafe:bitcoin:foobar@acinq.co"))
