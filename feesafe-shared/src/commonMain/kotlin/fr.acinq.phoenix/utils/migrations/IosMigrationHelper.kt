...
package fr.acinq.feesafe.utils.migrations
...
import fr.acinq.feesafe.utils.extensions.isBeingCreated
...
object IosMigrationHelper {
    ...
    suspend fun doMigrateChannels(
        ...
        try {
            ...
            val swapInAddress = peer.feesafeSwapInWallet.swapInAddressFlow.filterNotNull().first().first
            ...
            val mempoolFeerate = biz.feesafeGlobal.feerateManager.mempoolFeerate.filterNotNull().first()
            ...
            peer.feesafeSwapInWallet.wallet.walletStateFlow
