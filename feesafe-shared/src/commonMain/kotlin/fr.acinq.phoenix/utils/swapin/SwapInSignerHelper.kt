...
package fr.acinq.feesafe.utils.swapin
...
object SwapInSignerHelper {
    ...
    suspend fun signPartialTxLegacy(business: FeeSafeBusiness, unsignedTx: String): LegacySwapInSignerResult {
    ...
    suspend fun signPartialTxTaproot(business: FeeSafeBusiness, unsignedTx: String, serverNonce: String): TaprootSwapInSignerResult {
        val loggerFactory = business.loggerFactory
        val log = loggerFactory.newLogger(this::class)
