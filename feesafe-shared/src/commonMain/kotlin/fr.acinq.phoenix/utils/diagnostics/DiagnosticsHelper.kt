...
package fr.acinq.feesafe.utils.diagnostics
...
import fr.acinq.feesafe.managers.feesafeFinalWallet
import fr.acinq.feesafe.managers.feesafeSwapInWallet
import fr.acinq.feesafe.shared.BuildVersions
...
object DiagnosticsHelper {
    ...
    suspend fun getDiagnostics(business: FeeSafeBusiness): String {
        ...
        result.appendLine("mempoolspace feerate: ${business.feesafeGlobal.feerateManager.mempoolFeerate.first()}")
        ...
        val swapInWalletState = peerManager.getPeer().feesafeSwapInWallet.wallet.walletStateFlow.filterNotNull().first()
        ...
        result.appendLine("]")
        result.appendLine("final wallet address: ${peerManager.getPeer().feesafeFinalWallet.finalAddress}")
