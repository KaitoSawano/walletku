...
import fr.acinq.feesafe.controllers.config.CloseChannelsConfiguration.Model.ChannelInfoStatus
import fr.acinq.feesafe.utils.Parser
import fr.acinq.feesafe.utils.extensions.localBalance
...
class AppCloseChannelsConfigurationController(
    ...
    constructor(business: FeeSafeBusiness, isForceClose: Boolean): this(
        ...
        launch {
            ...
            peer.channelsFlow.collect { channels ->
                ...
                if (closingChannelIdsCopy != null) {
                    ...
                    val address = peer.feesafeFinalWallet.finalAddress
