...
package fr.acinq.feesafe.db.notifications
...
internal sealed class NotificationData {
    ...
    companion object {
        ...
        private fun Notification.asDb(): NotificationData = when (this) {
            ...
            is fr.acinq.feesafe.data.WatchTowerOutcome.Nominal -> WatchTowerOutcome.Nominal.V0(channelsWatchedCount)
            is fr.acinq.feesafe.data.WatchTowerOutcome.RevokedFound -> WatchTowerOutcome.RevokedFound.V0(channels)
            is fr.acinq.feesafe.data.WatchTowerOutcome.Unknown -> WatchTowerOutcome.Unknown.V0
        }
    }
}
