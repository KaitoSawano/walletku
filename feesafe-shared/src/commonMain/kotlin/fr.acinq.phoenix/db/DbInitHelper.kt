...
import fr.acinq.feesafe.db.sqldelight.*
...
object ContactInfoAdapter : ColumnAdapter<ContactInfo, ByteArray> {
    override fun decode(databaseValue: ByteArray): ContactInfo =
        fr.acinq.feesafe.db.serialization.contacts.Serialization.deserialize(databaseValue).getOrNull()
            ?: throw RuntimeException("cannot deserialize ${databaseValue.toHexString()}")

    override fun encode(value: ContactInfo): ByteArray = fr.acinq.feesafe.db.serialization.contacts.Serialization.serialize(value)
}