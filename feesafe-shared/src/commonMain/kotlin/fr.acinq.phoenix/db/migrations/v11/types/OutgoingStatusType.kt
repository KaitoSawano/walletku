...
package fr.acinq.feesafe.db.migrations.v11.types
...
sealed class OutgoingStatusData {
    ...
    sealed class SucceededOffChain : OutgoingStatusData() {
        @Serializable
        @SerialName("fr.acinq.feesafe.db.payments.OutgoingStatusData.SucceededOffChain.V0")
        data class V0(@Serializable val preimage: ByteVector32) : SucceededOffChain()
    }

    sealed class SucceededOnChain : OutgoingStatusData() {
        @Serializable
        @SerialName("fr.acinq.feesafe.db.payments.OutgoingStatusData.SucceededOnChain.V0")
        data class V0(
        ...
        @Serializable
        @SerialName("fr.acinq.feesafe.db.payments.OutgoingStatusData.SucceededOnChain.V1")
        data object V1 : SucceededOnChain()
    }

    sealed class Failed : OutgoingStatusData() {
        @Serializable
        @SerialName("fr.acinq.feesafe.db.payments.OutgoingStatusData.Failed.V0")
