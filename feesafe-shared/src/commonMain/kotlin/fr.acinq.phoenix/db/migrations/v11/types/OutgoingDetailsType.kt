...
sealed class OutgoingDetailsData {
    ...
    sealed class Normal : OutgoingDetailsData() {
        @Serializable
        @SerialName("fr.acinq.feesafe.db.payments.OutgoingDetailsData.Normal.V0")
        data class V0(val paymentRequest: String) : Normal()
    }

    sealed class SwapOut : OutgoingDetailsData() {
        @Serializable
        @SerialName("fr.acinq.feesafe.db.payments.OutgoingDetailsData.SwapOut.V0")
    ...
    sealed class Blinded : OutgoingDetailsData() {
        @Serializable
        @SerialName("fr.acinq.feesafe.db.payments.OutgoingDetailsData.Blinded.V0")
    ...
    sealed class Closing : OutgoingDetailsData() {
        @Serializable
        @SerialName("fr.acinq.feesafe.db.payments.OutgoingDetailsData.Closing.V0")
        data class V0(
