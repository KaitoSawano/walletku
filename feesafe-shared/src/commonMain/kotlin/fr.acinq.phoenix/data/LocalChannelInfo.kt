...
import fr.acinq.feesafe.utils.extensions.*
 ...
 *      while FeeSafe was disconnected). If false, this data is the live view of the channel as negotiated with the
...
data class LocalChannelInfo(
    ...
    companion object { /* allow companion extensions; see FeeSafeExposure.kt */ }
}
